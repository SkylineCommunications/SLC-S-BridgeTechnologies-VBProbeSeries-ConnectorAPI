namespace Skyline.DataMiner.ConnectorAPI.BridgeTechnologies.VBProbeSeries.Ethernet
{
	...
	public class CreateEthStreamResult : Message
	{
		...
		/// <summary>
		/// Indicates whether the newly created stream fully matches with the new stream request data.
		/// </summary>
	...
	public class EditEthStreamResult : Message
	{
		...
		/// <summary>
		/// Indicates whether the stream now fully matches with the requested changes.
		/// </summary>
		public bool IsFullMatch { get; set; }
